        ...
        switch (messageType) {
            case 0:
                ...
                for (int i = 0; i < objects.length; i++) {
                    ...
                    if (paramsType == ArrayList.class) {
                        objects[i] = JSONObject.parseArray(request.getParams()[i].toString(), Integer.class);
                    } else if (!paramsType.isAssignableFrom(request.getParams()[i].getClass())) {
            ...
            case 1:
                ...
                if (dataType == ArrayList.class) {
                    response.setData(JSONObject.parseArray(response.getData().toString(), Integer.class));
                } else if (!dataType.isAssignableFrom(response.getData().getClass())) {
